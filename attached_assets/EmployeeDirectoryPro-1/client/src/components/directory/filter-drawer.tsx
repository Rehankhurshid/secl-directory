    ...
    <>
      ...
      <div className="flex flex-wrap gap-2 mb-4 justify-center">
        <Button
          ...
          size="sm"
          onClick={() => handleQuickFilter('category', currentFilters.category === 'Monthly Rated' ? 'all' : 'Monthly Rated')}
        ...
        <Button
          ...
          size="sm"
          onClick={() => handleQuickFilter('category', currentFilters.category === 'Daily Rated' ? 'all' : 'Daily Rated')}
          className="rounded-full"
        >
          Daily Rated
        </Button>
        <Button
          ...
          size="sm"
          onClick={() => handleQuickFilter('gender', currentFilters.gender === 'Male' ? 'all' : 'Male')}
          className="rounded-full"
        >
          Male
        </Button>
        <Button
          ...
          size="sm"
          onClick={() => handleQuickFilter('gender', currentFilters.gender === 'Female' ? 'all' : 'Female')}
          className="rounded-full"
        >
          Female
        </Button>
